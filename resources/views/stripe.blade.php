                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 form-group required'>
                                <label class='control-label'>Name on Card</label> <input
                                    class='form-control' size='200' type='text'>
                            </div>
                        </div>
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-6 form-group card required'>
                                <label class='control-label'>Card Number</label> <input
                                    ...
                                    type='text' id='card-number-input'>
                            </div>
                            <div class="col-xs-6 form-group card required">
                                <label class="">Amount</label>
                                <input type="number" name="amount" autocomplete="off" class="form-control amount" id='amount-input' >
                            </div>
                        </div>
                        ...
                        <div class='form-row row'>
                            <div class='col-xs-12 col-md-4 form-group cvc required'>
                                <label class='control-label'>CVC</label> <input autocomplete='off'
                                    ...
                                    type='text' id='cvc-input'>
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                <label class='control-label'>Expiration Month</label> <input
                                    class='form-control card-expiry-month' placeholder='MM' size='2'
                                    type='text' id='month-input'>
                            </div>
                            <div class='col-xs-12 col-md-4 form-group expiration required'>
                                <label class='control-label'>Expiration Year</label> <input
                                    class='form-control card-expiry-year' placeholder='YYYY' size='4'
                                    type='text' id='year-input'>
                            </div>
                        </div>
...
// const inputField = document.getElementById('card-number-input');
// count = 0;
...
// If the alert element exists, set a timer to remove it after 10 seconds
if (alert) {
  setTimeout(() => {
    alert.remove();
  }, 10000);
